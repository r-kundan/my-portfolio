          ...
          <>
            <div className="relative w-[300px]  h-[500px] border-2 rounded-2xl p-2 shadow-lg">
              <div className="absolute w-[94%] h-[96.1%]  rounded-2xl flex-col  justify-evenly text-white flex items-center hover:opacity-0">
                ...
                <h4 className=" flex p-2 border-2 text-white justify-center rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 animate-pulse animate-infinite animate-duration-[2000ms] animate-ease-out ">
